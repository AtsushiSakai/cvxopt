...
def socp(c, Gl=None, hl=None, Gq=None, hq=None, A=None, b=None,
    ...
    if solver == 'mosek':
        ...
        msk.options = options.get('mosek', {})
        if p:
            raise ValueError("socp() with the solver = 'mosek' option "
...
def sdp(c, Gl=None, hl=None, Gs=None, hs=None, A=None, b=None,
    ...
    if a:
        raise TypeError("the squareroot of the number of rows in "
    ...
    if solver == 'dsdp':
        ...
        if p:
            raise ValueError("sdp() with the solver = 'dsdp' option "
                             "does not handle problems with equality constraints")
